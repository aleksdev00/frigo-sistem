...
$router = new Router();
$router->useLegacyRedirects(new LegacyRedirectService(require $basePath . '/config/redirects.php'));
...
$seoInfrastructure = new SeoInfrastructureController($publicCatalogRepository, new SeoService($config));
...
$router->get('/sitemap.xml', [$seoInfrastructure, 'sitemap']);
$router->get('/robots.txt', [$seoInfrastructure, 'robots']);
...
$router->get('/admin/analytics', [$analytics, 'index']);
