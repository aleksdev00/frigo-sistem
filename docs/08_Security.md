...
Phase 12 additionally rejects images above 40 million decoded pixels and limits each upload request to 10 files, bounding memory and CPU exposure before re-encoding.
